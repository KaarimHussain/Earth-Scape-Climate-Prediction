                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {useCases.map((useCase, index) => (
                        <motion.div
                            ...
                            whileHover={{ y: -10 }}
                            className="group relative h-[400px] bg-white/2 border border-white/5 hover:border-white/20 rounded-[2rem] p-8 flex flex-col justify-between overflow-hidden transition-all duration-500"
                        >
